...
context('Cypress APIs', () => {
  ...
  context('Cypress.config()', () => {
    ...
    // https://on.cypress.io/config
      ...
      expect(myConfig).to.have.property('viewportHeight', Cypress.config('viewportHeight'))
      expect(myConfig).to.have.property('viewportWidth', Cypress.config('viewportWidth'))
